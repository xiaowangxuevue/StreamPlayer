...
class MpdPlayer {
    constructor(player) {
        let mediaPlayer = factory().create(); // 创建了一个 MediaPlayer 类的实例
 ...
 */
        this.volumeBtn.onmouseenter = (e) => {
            ...
            console.log('上下左右', top, bottom, left, right);
...
export { $warn, BaseEvent, Controller, ERROR_MASK_MAP, ErrorMask, LOADING_MASK_MAP, LoadingMask, Mp4Player, MpdPlayer, Player, Progress, ToolBar, addZero, formatTime, getFileExtension, icon, parseDuration, string2boolean, string2number, styles, switchToSeconds };
