...
export declare function sendRequest(url: string, method: AxiosMethod, header: AxiosHeader, responseType?: XMLHttpRequestResponseType, data?: AxiosData): Promise<JSON | ArrayBuffer | string | Document | Blob | {
    [props: string]: any;
}>;
